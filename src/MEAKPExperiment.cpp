...
#include <turing/builders/MEABuilder.h>
#include <turing/builders/ParGABuilder.h>
#include <turing/core/solutions/Front.h>
#include <turing/mea/MEA.h>
#include <turing/mea/evaluations/EasyInstances.h>
#include <turing/mea/problems/EKPProblem.h>
#include <turing/mea/solutions/EKPSolution.h>
#include <turing/problems/KnapsackProblemNR.h>
#include <turing/types/SolutionTypes.h>
#include <turing/utilities/printer/InstPrinter.h>
...
using OP = KnapsackProblemNR;
using IS = EKPSolution;
using IP = EKPProblem;
using EA = AbstractEvolutionaryAlgorithm<OS>;
...
int main(int argc, char **argv) {
    ...
    auto instKP = make_unique<EKPProblem>(instanceSize, nInstances, 1,
                                          upperBound, 1, upperBound);

    string outFile = format(
        "MEA_KP_{}_generations_{}_PS_NS_K_3_threshold_100_"
        "Euclidean_WS_{}_{}_"
        "Inst_N_{}_"
        "Target_GA32PS_CR_{}_"
        "Evals_{}",
